      ...
      >
        ...
        >
          <View style={{ height: "35%", justifyContent: "space-between" }}>
            <Text
              style={{ color: COLORS.white, ...FONTS.prod_list_title_text }}
            >
              {item.name}
            </Text>
            <Text
              style={{ color: COLORS.white, ...FONTS.prod_list_price_text }}
            >
              {item.price}
            </Text>
          </View>
  ...
  function renderRecentlyViewed(item, index) {
    ...
    return (
      ...
      >
        ...
        >
          <Text style={{ color: COLORS.black, ...FONTS.product_title_text }}>
            {item.name}
          </Text>
